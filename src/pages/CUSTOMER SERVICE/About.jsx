    ...
    <Layout>
      <div className="m-4 text-white">
        <h3 className="text-2xl" style={{ textAlign: "center" }}>
          Welcome To <span id="W_Name1">SOFT GAME STUDIO</span>
        </h3>
        <div className="max-w-4xl mx-auto p-6  shadow-md">
          <h1 className="text-3xl font-bold mb-4">About Us</h1>
          <p className="mb-4">
            Welcome to <strong>SOFT GAME STUDIO</strong>, your go-to resource
            for all things programming! Founded with a passion for education and
          ...
          <p className="mb-4">
            At SOFT GAME STUDIO, we believe in empowering students and
            developers by providing high-quality educational content. Our
            mission is to make learning programming languages easy and enjoyable
            through detailed notes, practical examples, and engaging video
            lectures.
          </p>
          ...
          <p>
            ...
            or an experienced developer seeking to expand your skills, SOFT GAME
            STUDEO is here to support you every step of the way. Join our
            community and start learning today!
          </p>
        </div>
        <br />
